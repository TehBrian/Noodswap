...
FLIP_WIN_PAYOUT_MULTIPLIER_NUMERATOR = 18
FLIP_WIN_PAYOUT_MULTIPLIER_DENOMINATOR = 10
FLIP_LOSS_POT_CONTRIBUTION_NUMERATOR = 2
FLIP_LOSS_POT_CONTRIBUTION_DENOMINATOR = 10
MONOPOLY_ROLL_COOLDOWN_SECONDS = 3 * 60 + 30
MONOPOLY_BOARD_SIZE = 40
MONOPOLY_GO_REWARD_DOUGH = 2000
MONOPOLY_CHEESE_TAX_PERCENT = 7
...
MONOPOLY_PROPERTY_TRANSACTION_FEE_POT_CONTRIBUTION_NUMERATOR = 1
MONOPOLY_PROPERTY_TRANSACTION_FEE_POT_CONTRIBUTION_DENOMINATOR = 10
OVEN_TRANSACTION_FEE_NUMERATOR = 8
