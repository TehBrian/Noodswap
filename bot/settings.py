...
MONOPOLY_GO_REWARD_DOUGH = 1000
MONOPOLY_TOMATO_TAX_PERCENT = 7
MONOPOLY_TRUFFLE_TAX_PERCENT = 15
MONOPOLY_JAIL_FINE_DOUGH = 2150
...
STARTING_DOUGH = 0
STARTING_STARTER = 0
TOPGG_VOTE_REWARD_STARTER = 3
TOPGG_VOTE_REWARD_DOUGH = 500
TOPGG_VOTE_REWARD_LOOTBOX_KEYS = 1
DISCORDBOTLIST_VOTE_REWARD_DROP_TICKETS = 2
DISCORDBOTLIST_VOTE_REWARD_PULL_TICKETS = 1
# Backward-compatible alias retained for older call sites/tests.
VOTE_STARTER_REWARD = TOPGG_VOTE_REWARD_STARTER
COMMAND_PREFIX = "ns "
...
DISCORDBOTLIST_WEBHOOK_SECRET = os.getenv("DISCORDBOTLIST_WEBHOOK_SECRET", "").strip()
DISCORDBOTLIST_WEBHOOK_HOST = os.getenv("DISCORDBOTLIST_WEBHOOK_HOST", TOPGG_WEBHOOK_HOST).strip() or TOPGG_WEBHOOK_HOST
DISCORDBOTLIST_WEBHOOK_PORT = _env_int("DISCORDBOTLIST_WEBHOOK_PORT", TOPGG_WEBHOOK_PORT)
DISCORDBOTLIST_WEBHOOK_PATH = os.getenv(
    "DISCORDBOTLIST_WEBHOOK_PATH",
    "/noodswap/discordbotlist-vote-webhook",
).strip()
DISCORDBOTLIST_WEBHOOK_MAX_BODY_BYTES = _env_int("DISCORDBOTLIST_WEBHOOK_MAX_BODY_BYTES", 16 * 1024)
DISCORDBOTLIST_WEBHOOK_REQUIRE_JSON_CONTENT_TYPE = _env_bool("DISCORDBOTLIST_WEBHOOK_REQUIRE_JSON_CONTENT_TYPE", True)
DISCORDBOTLIST_WEBHOOK_ALLOWED_IPS = _env_csv("DISCORDBOTLIST_WEBHOOK_ALLOWED_IPS")

TOPGG_VOTE_URL = os.getenv("TOPGG_VOTE_URL", "https://top.gg/bot/1478727078286196909/vote").strip()
DISCORDBOTLIST_VOTE_URL = os.getenv(
    "DISCORDBOTLIST_VOTE_URL",
    "https://discordbotlist.com/bots/noodswap/upvote",
).strip()
